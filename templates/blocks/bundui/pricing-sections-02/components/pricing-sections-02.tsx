  ...
  return (
    <section className="py-12 lg:py-20">
      <div className="container mx-auto px-4">
        <div className="mx-auto flex max-w-2xl flex-col items-center space-y-6 text-center lg:space-y-8">
          <header className="mb-4 space-y-4">
            <h2 className="font-heading text-4xl lg:text-5xl">Flexible Plans for Every Stage</h2>
